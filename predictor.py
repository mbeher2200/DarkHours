...
def assemble_night(
    ...
    night_start = se.find_event(events, "Night begins", after=sunset, before=sunrise)
    night_end   = se.find_event(events, "Night ends",   after=night_start or sunset, before=sunrise)
